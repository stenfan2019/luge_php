<div class="layui-form" lay-filter="action_form" id="action_form" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             <input type="text" name="card" value="<?=$item['card']?>"  lay-verify="required" maxlength="19" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">分行地址</label>
        <div class="layui-input-block">
             <input type="text" name="address"value="<?=$item['address']?>" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
        </div>
    </div>
   <div class="layui-form-item">
        <label class="layui-form-label">总存款</label>
        <div class="layui-input-inline" style="width: 100px;">
            <input type="text" name="limit_max" value="<?=$item['limit_max']?>"  maxlength="8" lay-verify="required"  autocomplete="off"
                   class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <input type="text" name="limit_day_max" value="<?=$item['limit_day_max']?>"  maxlength="8" lay-verify="required"  autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <input type="text" name="limit_once_min" value="<?=$item['limit_once_min']?>"  maxlength="8" lay-verify="required"  autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 100px;">
            <input type="text" name="limit_once_max" value="<?=$item['limit_once_max']?>" maxlength="8" lay-verify="required"  autocomplete="off"
                   class="layui-input">
        </div>
    </div>
