...
<script>
    layui.use(['index', 'table', 'admin'], function () {
        ...
        table.render({
            elem: '#data_list'
            , url: '/collect/list?data=1'
            , cols: [[
                  {field: 'id', title: 'ID',align:'left'}
                , {field: 'name', title: '开户人',align:'left'}
                , {field: 'card', title: '卡号',align:'center',width:"16%"}
                , {field: 'address', title: '分行',align:'center'}
                , {field: 'total', title: '累计金额',align:'center'}
                , {field: 'today', title: '今日金额',align:'center'}
                , {field: 'limit_once_min', title: '单次最小',align:'center'}
                , {field: 'limit_once_max', title: '单次最大',align:'center'}
                , {field: 'limit_day_max', title: '单日最大',align:'center'}
        ...
        table.on('tool(data_list)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                layer.open({
                    type: 2
                    , title: '修改信息'
                    , content: '/collect/edit?id=' + data.id
                    , maxmin: true
                    , area: ['650px', '600px']
                    , btn: ['确定', '取消']
