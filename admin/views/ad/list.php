    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-list" data-type="add">添加Banner</button>
            </div>
    ...
    layui.use(['index', 'table', 'admin'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'image', title: '图片地址',align:'left'}
                , {field: 'cate_title', title: '终端',align:'center'}
                , {field: 'type_title', title: '跳转方式',align:'center'}
                , {field: 'site_title', title: '广告位置',align:'center'}
                , {field: 'url', title: '跳转地址',align:'center'}
                , {field: 'is_show_title', title: '是否显示',align:'center'}
