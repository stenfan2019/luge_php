<div class="layui-form" lay-filter="action_form" id="action_form" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <select>
                    <option value="<?=$type_names?>"><?=\common\models\ActiveType::getTypeName($type_names)?></option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item" id="condition">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width:120px">
                <input type="text" name="condition[<?=$key?>][]" placeholder="请输入<?=$val['name']?>" autocomplete="off" class="layui-input" style ="width:120px">
            </div>
        </div>
        <?php } ?>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style ="width:80px">
                <select name="bonus[name][]">
                    <?=$select_bonus?>
                </select>
            </div>
            <div class="layui-input-inline" style="width:90px">
                <input type="text" name="bonus[value][]" placeholder="请输入数字" autocomplete="off" class="layui-input" style ="width:90px">
            </div>
        </div>
        </object>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             <input type="text" id="web_pic" name="web_pic" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="pc_pic" name="pc_pic" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
        <textarea id="descript" name="descript" style="display: none;" lay-verify="descript"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">开始时间</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" id="start_time" name="start_time" placeholder="选择开始时间">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">截至时间</label>
        <div class="layui-input-inline">
            <input type="text" class="layui-input" id="end_time" name="end_time" placeholder="选择截止时间">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.use(['index', 'form', 'admin','upload','layedit'], function () {
        ...
        form.on('submit(form_submit)', function (data) {
            ...
            data.field.descript = layedit.getContent(content);
    ...
    function add_con(obj){
        ...
        $(obj).remove();
        htmls += '<button onclick="add_con(this)" type="button" class="layui-btn" style ="width:80px">添加<i class="layui-icon"></i></button>';
