<div class="layui-form" lay-filter="action_form" id="action_form" style="padding: 20px 30px 0 0;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             <input type="text" name="code" lay-verify="required" value="<?=$item['code']?>" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">银行简称</label>
        <div class="layui-input-block">
             <input type="text" name="shortname" lay-verify="required" value="<?=$item['shortname']?>" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">银行logo</label>
        <div class="layui-input-block">
             <input type="text" id="show_pic" name="logo" lay-verify="required" value="<?=$item['logo']?>" autocomplete="off" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
             <input type="text" name="url" value="<?=$item['url']?>" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
