    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-list" data-type="add">添加银行</button>
            </div>
...
<script>
    layui.use(['index', 'table', 'admin'], function () {
        ...
        table.render({
            elem: '#data_list'
            , url: '/bank/list?data=1'
            , cols: [[
                  {field: 'id', title: 'ID',align:'left'}
                , {field: 'code', title: '银行编码',align:'left'}
                , {field: 'name', title: '银行名称',align:'left'}
