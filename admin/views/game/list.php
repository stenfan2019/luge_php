    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-list" data-type="add">添加游戏</button>
            </div>
...
<script>
    layui.use(['index', 'table', 'admin'], function () {
        ...
        table.render({
            elem: '#data_list'
            , url: '/game/list?data=1'
            , cols: [[
                  {field: 'id', title: 'ID',align:'left'}
                , {field: 'game_title', title: '游戏名称',align:'left'}
                , {field: 'icon', title: '礼物价格',align:'left'}
                , {field: 'sort', title: '显示顺序',align:'center'}
                , {field: 'show_on_title', title: '展示',align:'center'}
