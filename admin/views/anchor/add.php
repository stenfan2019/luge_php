<div class="layui-form" lay-filter="action_form" id="action_form" style="padding: 20px 30px 0 0;">
   ...
   <div class="layui-form-item more_option">
    ...
    <div class="layui-form-item more_option">
        ...
        <div class="layui-input-inline">
            <input type="text" name="live_rate" value="60" lay-verify="required|number"  autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item more_option">
        <label class="layui-form-label">礼物抽成</label>
        <div class="layui-input-inline">
            <input type="text" name="game_rate" value="2" lay-verify="required|number"  autocomplete="off" class="layui-input">
        </div>
    </div>
