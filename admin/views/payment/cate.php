    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-list" data-type="add">添加支付方式</button>
            </div>
        ...
        table.on('tool(data_list)', function (obj) {
            ...
            if (obj.event === 'del') {
            	layer.confirm('确定删除此内容？', function (index) {
                    admin.req({
                        type: 'post',
                        url: '/payment/catedel?id='+ data.id,
                        dataType: 'json',
                        data: {id: data.id},
                ...
                layer.open({
                    type: 2
                    , title: '修改信息'
                    , content: '/payment/cateedit?id=' + data.id
                    , maxmin: true
                    , area: ['650px', '600px']
                    , btn: ['确定', '取消']
