...
/**
 * Class m200929_083524_user_bank
 */
class m200929_083524_user_bank extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function up()
    {
        ...
        /* 创建表 */
        $this->createTable('{{%user_banks}}', [
            'id' => 'int(11) unsigned NOT NULL AUTO_INCREMENT',
            'uid' => 'int(11) unsigned NOT NULL DEFAULT \'0\' COMMENT \'主播ID\'',
    ...
    public function down()
    {
        echo "m200929_083524_user_bank cannot be reverted.\n";
